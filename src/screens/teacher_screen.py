...
def teacher_tab_attendance_records():
    ...
    if not records:
        st.info('No attendance records yet. Run an attendance session to see results here.')
        return
...
def teacher_screen_login():
    ...
    st.markdown('<div class="auth-title">Login using password</div>', unsafe_allow_html=True)
...
def teacher_screen_register():
    ...
    st.markdown('<div class="auth-title">Register your teacher profile</div>', unsafe_allow_html=True)
